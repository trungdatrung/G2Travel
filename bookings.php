...
<head>
  ...
  <title><?php echo $settings_r['site_title'] ?> - Booking History</title>
</head>
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 my-5 px-4">
        <h2 class="fw-bold h-font">Booking History</h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">Home</a>
          <span class="text-secondary"> > </span>
          <a href="#" class="text-secondary text-decoration-none">Booking History</a>
        </div>
      </div>
