...
<body class="bg-light">
  ...
  <div class="container availability-form">
    <div class="row">
      <div class="col-lg-12 bg-white shadow p-4 rounded">
        <h5 class="mb-4 fw-bold h-font">Book Your Travel Package</h5>
  ...
  <div class="container">
    <div class="row">
            ...
            <div class="col-lg-4 col-md-6 my-3">
              <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                ...
                <div class="card-body">
                  ...
                  <h6 class="mb-4">$room_data[price] VND / person</h6>
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="rooms.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">View More >>></a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">View More >>></a>
      </div>
    </div>
  </div>
  ...
  <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">Customer Reviews</h2>
      ...
      <div class="col-lg-4 col-md-4">
        ...
        <div class="bg-white p-4 rounded mb-2">
          ...
          if ($contact_r['tw'] != '') {
            ...
            echo <<<data
                <a href="$safe_tw" class="d-inline-block mb-3">
  ...
  if (isset($_GET['account_recovery'])) {
    ...
    if (mysqli_num_rows($query) == 1) {
      ...
      alert("error", "Link is no longer valid!");
    }
    ...
    recovery_form.addEventListener('submit', (e) => {
      ...
      xhr.onload = function () {
        if (this.responseText == 'failed') {
          ...
          alert('success', "Account recovered successfully!");
          recovery_form.reset();
        }
      }
