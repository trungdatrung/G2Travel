...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    Contact us now via hotline, email, or online form for consultation and inquiries. <br>
    Our team will respond quickly to ensure customer satisfaction.
    </p>
  </div>
  ...
  <?php 
    ...
    if(isset($_POST['send']))
    {
      ...
      if($res==1){
        ...
        alert('error','Server is under maintenance! Please try again later.');
      }
    }
  ?>
