...
function add_image() {
  ...
  data.append('csrf_token', carousel_s_form.elements['csrf_token'].value);
...
function rem_image(val) {
  ...
  xhr.send('rem_image=' + val + '&csrf_token=' + document.querySelector("#carousel-s input[name='csrf_token']").value);
}
