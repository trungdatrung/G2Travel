    ...
    <div class="container-fluid flex-lg-column align-items-stretch">
      ...
      <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            ...
            <div class="collapse show px-3 small mb-1" id="bookingLinks">
              <ul class="nav nav-pills flex-column rounded border border-secondary">
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="refund_bookings.php">Refund Requests</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="rooms.php">Tour Packages</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="features_facilities.php">Features & Services</a>
          </li>
          <li class="nav-item">
