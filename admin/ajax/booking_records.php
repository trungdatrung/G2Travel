  ...
  while ($data = mysqli_fetch_assoc($limit_res)) {
    ...
    $table_data .= "
        <tr>
          ...
          <td>
            <b>Amount:</b> " . htmlspecialchars($data['trans_amt']) . " VND
            <br>
            <b>Date:</b> $date
          </td>
          <td>
            <span class='badge $status_bg'>" . htmlspecialchars($data['booking_status']) . "</span>
          </td>
          <td>
            <a href='generate_pdf.php?gen_pdf&id=$data[booking_id]' class='btn btn-outline-success btn-sm fw-bold shadow-none' target='_blank'>
